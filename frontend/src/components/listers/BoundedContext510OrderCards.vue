    ...
    <div>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <BoundedContext510Order :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <BoundedContext510Order :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
...
<script>
    ...
    import BoundedContext510Order from './../BoundedContext510Order.vue';

    export default {
        name: 'BoundedContext510OrderManager',
        components: {
            BoundedContext510Order,
        },
        props: {
            offline: Boolean
        },
